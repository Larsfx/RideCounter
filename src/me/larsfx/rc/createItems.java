...
public class createItems {
	...
	public static void createCustomItemLores(Inventory inv, Material material, byte byt, String displayName, int slot, String lore) {		
	...
	public static void createCustomItem(Inventory inv, Material material, byte byt, String displayName, int slot) {		
		ItemStack chest2 = new ItemStack(material, 1, (byte) byt);
		ItemMeta plate2 = chest2.getItemMeta();
		plate2.setDisplayName(displayName);
		chest2.setItemMeta(plate2);
